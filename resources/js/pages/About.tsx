                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-gray-800 rounded-lg p-6 text-center">
                                ...
                                <p className="text-gray-300">
                                    Sistem keamanan berlapis dan verifikasi kampanye untuk memastikan donasi Anda sampai ke tujuan yang tepat.
                                </p>
                            </div>
                            ...
                            <div className="bg-gray-800 rounded-lg p-6 text-center">
                                ...
                                <p className="text-gray-300">
                                    Laporan real-time dan update berkala tentang penggunaan dana untuk setiap kampanye donasi.
                                </p>
                            </div>
                            ...
                            <div className="bg-gray-800 rounded-lg p-6 text-center">
                                ...
                                <p className="text-gray-300">
                                    Interface yang intuitif dan proses donasi yang sederhana, dapat diakses dari berbagai perangkat.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-8 mb-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
                            <div>
                                ...
                                <div className="text-blue-100">Kampanye Berhasil</div>
                            </div>
                            <div>
                                <div className="text-4xl font-bold text-white mb-2">50K+</div>
                                <div className="text-blue-100">Donatur Aktif</div>
                            </div>
                            <div>
                                <div className="text-4xl font-bold text-white mb-2">15M+</div>
                                <div className="text-blue-100">Dana Terkumpul</div>
                            </div>
                            <div>
                                <div className="text-4xl font-bold text-white mb-2">100K+</div>
                                <div className="text-blue-100">Orang Terbantu</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="text-center">
                                ...
                                <p className="text-gray-300">
                                    Jelajahi berbagai kampanye donasi yang telah terverifikasi dan pilih yang sesuai dengan hati Anda.
                                </p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-gray-300">
                                    Tentukan nominal donasi dan pilih metode pembayaran yang tersedia dengan proses yang aman.
                                </p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-gray-300">
                                    Dapatkan update berkala tentang perkembangan kampanye dan dampak dari donasi yang Anda berikan.
                                </p>
                            </div>
                        </div>
                    </div>
