    ...
    public function run(): void
    {
        ...
        $campaigns = [
            ...
            [
                ...
                'status' => 'active',
                'featured_image' => 'campaigns/sumur-wakaf.jpg',
            ...
            [
                ...
                'category' => 'Pendidikan',
                'status' => 'active',
                'featured_image' => 'campaigns/beasiswa-vokasi.jpg',
            ...
            [
                ...
                'category' => 'Kesehatan',
                'status' => 'active',
                'featured_image' => 'campaigns/makanan-balita.jpg',
            ...
            [
                ...
                'category' => 'Lingkungan',
                'status' => 'active',
                'featured_image' => 'campaigns/rehabilitasi-mangrove.jpg',
            ...
            [
                ...
                'status' => 'active',
                'featured_image' => 'campaigns/sekolah-banjir.jpg',
            ...
            [
                ...
                'category' => 'Kemanusiaan',
                'status' => 'active',
                'featured_image' => 'campaigns/kaki-palsu.jpg',
            ...
            [
                ...
                'category' => 'Kesehatan',
                'status' => 'active',
                'featured_image' => 'campaigns/operasi-jantung.jpg',
            ...
            [
                ...
                'category' => 'Kemanusiaan',
                'status' => 'active',
                'featured_image' => 'campaigns/makanan-anak-jalanan.jpg',
            ...
            [
                ...
                'category' => 'Hewan',
                'status' => 'active',
                'featured_image' => 'campaigns/rehabilitasi-burung.jpg',
                'deadline' => now()->addMonths(4),
                'donors_count' => 0,
            ],
            [
                ...
                'category' => 'Bencana Alam',
                'status' => 'active',
                'featured_image' => 'campaigns/jembatan-longsor.jpg',
                'deadline' => now()->addMonths(5),
                'donors_count' => 0,
            ],
        ];
